...
(def word-transactions (partition-all 3 1 words))

(defn word-chain [word-transactions]
...
(defn text->word-chain [s]
  (let [words (clojure.string/split s #"[\s|\n]")
        word-transactions (partition-all 3 1 words)]
    (word-chain word-transactions)))
